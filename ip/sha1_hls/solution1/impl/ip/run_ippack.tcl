...
set Library     "hls"
set IPName      "sha1_control"
set Version     "1.0"
set DisplayName "sha1_interface"
set Revision    "1901271355"
set Description "sha1_interface"
set Device      "zynq"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 i_cs W 0x0 "Data signal of i_cs" {{0 1 i_cs W 0 "Bit 0 to 0 Data signal of i_cs"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 i_we W 0x0 "Data signal of i_we" {{0 1 i_we W 0 "Bit 0 to 0 Data signal of i_we"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 i_address W 0x0 "Data signal of i_address" {{0 8 i_address W 0 "Bit 7 to 0 Data signal of i_address"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 i_write W 0x0 "Data signal of i_write" {{0 32 i_write W 0 "Bit 31 to 0 Data signal of i_write"}}} {0x30 o_read R 0x0 "Data signal of o_read" {{0 32 o_read R 0 "Bit 31 to 0 Data signal of o_read"}}} {0x34 o_read_ctrl R 0x0 "Control signal of o_read" {{0 1 o_read_ap_vld R 0 "Control signal o_read_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 o_error R 0x0 "Data signal of o_error" {{0 1 o_error R 0 "Bit 0 to 0 Data signal of o_error"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x3c o_error_ctrl R 0x0 "Control signal of o_error" {{0 1 o_error_ap_vld R 0 "Control signal o_error_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
